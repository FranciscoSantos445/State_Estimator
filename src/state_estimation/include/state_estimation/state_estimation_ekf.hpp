...
class KalmanFilter {
    public:
        ...
        Eigen::Matrix<double,9,15> const & getCMatrix() const;
        TireInfoStruct const  getTireInfo(uint8_t id)const;
        Eigen::Matrix<double,9,1> getMeasurementVector() const;
        Eigen::Matrix<double,9,1> getPredictedVector() const;
        Eigen::Matrix<double,9,1> const & getInnovation() const;
        Eigen::Matrix<double,9,9> const & getInnovationCovariance() const;
    ...
    private:
        ...
        StateMatrices discretizeModel(const Eigen::Matrix<double,15,15> &A_c, const Eigen::Matrix<double,15,4> &B_c);
        ...
        Eigen::Matrix<double,9,1> _innovation;
        Eigen::Matrix<double,9,9> _S;

        Eigen::Matrix<double,9,15> _C;
        const double _ts = 0.01;
        double lon_wt, lat_wt, downforce;
};
